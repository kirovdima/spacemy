...
class MonthPeriod implements PeriodInterface
{
    ...
    {
        return date('Y-m-d H:i:s', strtotime('first day of this month', strtotime($start_date)));
    }
    ...
    {
        return date('Y-m-d H:i:s', strtotime('first day of next month', strtotime($start_date)));
    }
